...
#define DATE "built on: Thu Aug 27 10:51:31 2020 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','i','u','d','h',
    '/','K','i','v','y','/','e','j','e','m','p','l','o','_','k','i',
